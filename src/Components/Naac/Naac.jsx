                        ...
                        <table class="table-fixed ml-8">
                            <thead>
                                <tr className="hover-table hover-table-top-row">
                                    <th
                                        className="text-lg normal-case table-data updated-font-family"
                                        style={{ width: "100px" }}
                                    >
                                        S. No
                                    </th>
                            ...
                            <tbody>
                                {ResultsAcademicsData.map((doc) => (
                                    <tr className="hover-table">
                                        ...
                                        <td className="table-data updated-font-family tableFontStyle  teacher-paragraph">
                                            <a
                                                target="_blank"
                                                href={doc?.document}
                                                rel="noreferrer"
                                                className="flex justify-center text-custom-blue"
                                            >
                                                View
                                            </a>{" "}
                                        </td>
