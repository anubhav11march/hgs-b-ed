                        ...
                        <div class="flex justify-center flexProp flex-col lg:flex-row">
                            ...
                            <div className="ml-0 lg:ml-6">
                                ...
                                <p className="mt-2 updated-font-family teacher-paragraph">
                                    ...
                                    experienced the bliss, with which this
                                    wonderful institution nurtures an
                                    individual. Each and every block of the
                                    institution act as a stepping stone for us,
                                    thus augmenting each and every one of their
                                    qualities- be it academic prowess in
                                    securing a high percentage or versatility on
                                    the stage and games field The institution
                                    under the able guidance of our Principal
                                    ma’am has the embellishment of a caring,
                                    loving and learning atmosphere and that
                                    makes all the difference. And today I’m
                                    working in Sherwood College, Nainital as the
                        ...
                        <div class="flex justify-center flexProp flex-col-reverse lg:flex-row">
                            <div className="">
                                ...
                                <p className="mr-6 updated-font-family teacher-paragraph">
                                    I’m amongst the many students of the
                                    institution whose life changed not only
                                    academically but also mentally and
                                    emotionally after joining the Institute. The
                                    college focuses not only on making the
                                    finest of all teachers but also good humans
                                    and citizens. It’s the continuous toiling of
                                    the Principal and staff of the college that
                                    it has become one of the best and most
                                    revered colleges of education in the state.
                                    What I’m today, I totally owe to the hard
                                    work and values instilled by the institute
                                    in me, I m working as Lecturer English,
                    ...
                    <div class=" mt-2 mb-[50px] ml-6 mr-6">
                        <div class="flex justify-center flexProp flex-col lg:flex-row">
                            ...
                            <div className="ml-0 lg:ml-6">
                                ...
                                <p className="mt-2 updated-font-family teacher-paragraph">
                                    Certain milestones bring drastic changes in
                                    your life, coming to J. N. Kaul was one of
                                    them. The Institution didn't just work on
                                    our academics but ensured our participation
                                    in various co-curricular activities and
                                    community services which can prepare a
                                    teacher to cater the needs of their
                                    prospective career. Also we got ample of
                                    opportunities to use latest technologies
                                    which enabled us to stand with the
                                    ever-changing modern world and improve the
                                    teaching-learning process. As I joined JNKIE
                                    a completely different journey started
                                    because It was not a regular college which
                                    generally focuses on the academics and
                                    neglects the all round development of the
                                    students. From the first week of my
                                    admission I had to participate in the varied
                                    activities which I was not comfortable
                                    earlier on. But gradually I saw the
                                    difference in me and my friends we were more
                                    confident and active which is an relevant
                                    for every individual to succeed in life,
                                    meanwhile I qualified the NET/JRF
                                    examination In Education with the utmost
                                    support and guidance of the Principal and
                                    staff and right now doing my Ph. D. course
                                    work.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class=" mt-2 mb-[50px] ml-6 mr-6">
                        <div class="flex justify-center flexProp flex-col-reverse lg:flex-row">
                            <div className="mr-6">
                                ...
                                <p className="mt-2 updated-font-family teacher-paragraph">
                                    It had been a while for me after leaving
                                    formal education but coming here just not
                                    made me a disciplined person but also
                                    motivated me to explore my capabilities,
                                    skills and talents. My perception towards
                                    the teaching profession especially with the
                                    experience during my practice teaching.
                                </p>
                            </div>
                            <img
                                src={teacher4}
