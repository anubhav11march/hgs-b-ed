...
const AboutInstitution = () => {
    return (
        <div className='margin-for-institute ml-0 lg:ml-[80px] mr-0 lg:mr-[80px]' id='home'>
            <div>
                <div className='mt-8 mb-8 w-full'>
                    <h1 className='welcome aboutWelcome updated-font-family'>Welcome to J.N Kaul Institute of Education</h1>
